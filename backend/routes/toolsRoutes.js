...
router.post('/api/tools/log-tracker-search', toolsController.logTrackerSearch);
router.post('/api/tools/log-jurisdiction-check', toolsController.logJurisdictionCheck);
router.post('/api/tools/log-ec261-calc',         toolsController.logEc261Calc);
